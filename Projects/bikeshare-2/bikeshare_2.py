...
def trip_duration_stats(df):
    ...
    total_travel_time_minutes = round(total_travel_time / 60,2)
    print("Total travel time: {} minutes, number of travels: {}".format(total_travel_time_minutes, len(df['Trip Duration'])))
